...
The proxy simply forward the WebSocket handshake request headers (including the `connection` header) and the handshake
is performed between the user agent and the origin server.
