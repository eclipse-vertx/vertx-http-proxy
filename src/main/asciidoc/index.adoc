...
You can use body interceptor to create body transformations for common data types, like json and string:
...
Or work with raw bytes using buffer:

[source,java]
----
{@link examples.HttpProxyExamples#bodyInterceptorBuffer}
----
